...
public class TeacherSpecification {
    ...
    public static Specification<Teacher> hasLastname(String lastname) {
        return ((root, query, criteriaBuilder) -> lastname == null
                ? criteriaBuilder.conjunction() : criteriaBuilder.like(criteriaBuilder.lower(root.get("lastname")), "%" + lastname + "%"));
    }

    public static Specification<Teacher> hasRegion(String region) {
        return ((root, query, criteriaBuilder) -> region == null
                ? criteriaBuilder.conjunction() : criteriaBuilder.like(criteriaBuilder.lower(root.get("region")), "%" + region + "%"));
    }

    public static Specification<Teacher> isDeleted(boolean deleted) {
