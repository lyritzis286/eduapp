...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ValidationErrorResponseDTO> handleValidationException(ValidationException e) {
        ...
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)     //400 Bad Request
                .body(new ValidationErrorResponseDTO(e.getCode()
                        , e.getMessage(), errors));
    }
    ...
    public ResponseEntity<ErrorResponseDTO> handleAuthenticationException(AuthenticationException e,
        ...
        public ResponseEntity<ErrorResponseDTO> handAccessDeniedException(AccessDeniedException e) {
            log.warn("Access denied. Message={}", e.getMessage());
            return ResponseEntity
                    .status(HttpStatus.FORBIDDEN)   //403 forbidden
                    .body(new ErrorResponseDTO("AccessDenied", e.getMessage()));
        }
